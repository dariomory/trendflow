...
If you find a security vulnerability in Trendflow, please report it through [GitHub's private vulnerability reporting](https://github.com/dariomory/trendflow/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact dario@mory.dev for details.
